...
import withShopSale from "custom/containers/sales/withShopSale";
...
export default class SaleDetailPage extends Component {
  ...
  renderSale() {
    const { addItemsToCart, initialGridSize, sale, shop } = this.props;
  ...
  renderMainArea() {
    const { isLoadingSale, sale, shop } = this.props;
